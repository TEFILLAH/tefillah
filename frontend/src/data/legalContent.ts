...
export const privacyContent = [
  ...
  },
  {
    title: 'Your Rights',
    content:
      'You can delete your account and all associated data yourself at any time from Menu → Profile Settings → Delete account in the app, or from our account deletion page at tefillah.in/delete-account. Deleting removes your profile, photo, notification token and notifications, and strips your identity from past prayer requests. You also have the right to access your personal data, request correction of inaccurate data, opt out of non-essential communications, and export your prayer history. To exercise these rights, contact us at admin@tefillah.in.',
  },
  {
    title: 'Data Retention',
    content:
      'Account data is retained as long as your account is active. Prayer requests are retained for the purpose of maintaining your prayer history. You can delete your account and all associated data instantly at any time from Menu → Profile Settings → Delete account, or contact our support team for help.',
  },
  {
