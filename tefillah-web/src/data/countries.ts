// Comprehensive ISO-3166 country list with E.164 dial codes.
// Regenerated after file corruption; consumers use { iso2, name, dial }.
...
export function countryByIso(iso: string): Country | undefined {
  return COUNTRIES.find((c) => c.iso2 === iso);
}
